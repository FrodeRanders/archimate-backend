...
class AuthorizationServiceIdentityModeTest {
    ...
    void oidcWebSocketSubjectUsesHandshakePrincipalAndRoles() {
        ...
        userProperties.put(ArchimeshEndpointConfigurator.HANDSHAKE_PRINCIPAL_NAME_KEY, "ws-user");
        userProperties.put(ArchimeshEndpointConfigurator.HANDSHAKE_ROLES_KEY, Set.of("admin", "model_reader"));
