...
/**
 * Dialog for mesh connection settings.
 */
public class ArchimeshConnectDialog extends TitleAreaDialog {
    ...
    public ArchimeshConnectDialog(Shell parentShell, String wsBaseUrl, String modelId, String userId, String sessionId, String authToken) {
        super(parentShell);
