...
public class ArchimeshStatusLineBridge implements IWindowListener, IPartListener,
    ...
    public ArchimeshStatusLineBridge(ArchimeshSessionManager sessionManager) {
    ...
    private void runOnUiThreadSync(Runnable runnable) {
        ...
        try {
            ...
            ArchimeshPlugin.logDebug("Skipping status-line UI stop due to SWT shutdown: " + ex.getMessage());
        }
    }
